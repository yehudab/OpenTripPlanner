...
public class RouteGeometrySet {
    public List<EncodedPolylineBean> edges = new ArrayList<EncodedPolylineBean>();
    
    public List<String> variantNames = new ArrayList<String>();
